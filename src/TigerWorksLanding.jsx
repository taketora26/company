  ...
  const works = [
    {
      ...
      note: t(
        "東京都あきる野市古民家（築50年）",
        "Traditional house in Akiruno, Tokyo (50 years old)"
      ),
    },
    {
      ...
      note: t(
        "埼玉県熊谷市古民家（築64年）",
        "Traditional house in Kumagaya, Saitama (64 years old)"
      ),
    },
    {
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900">
      ...
      <section id="top" className="relative">
        <div className="absolute inset-0 bg-gradient-to-b from-neutral-100 to-white"></div>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <a
                  href="#services"
                  className="px-5 py-3 rounded-2xl bg-neutral-900 text-white text-sm font-medium hover:opacity-90"
                >
                  {t("事業内容", "Our Services")}
                </a>
                <a
                  href="#contact"
                  className="px-5 py-3 rounded-2xl border text-sm font-medium hover:bg-neutral-50"
                >
                  {t("相談する", "Contact us")}
                </a>
              </div>
              <div className="mt-6 text-xs text-neutral-500">
                {t(
                  "拠点：東京都昭島市 / 対応エリア：多摩・西東京・埼玉・神奈川",
                  "Base: Akishima, Tokyo / Service area: West Tokyo, Tama, Saitama, Kanagawa"
                )}
              </div>
            </div>
      ...
      <section id="services" className="py-16 sm:py-20 bg-neutral-50 border-t border-neutral-100">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="mt-2 text-neutral-600 text-sm">
            {t("小規模でも品質重視で確実に。現場主義でスピーディに対応します。", "Small scale, high quality. Fast, on-site execution.")}
          </p>
            ...
            {[
              {
                ...
                desc: t(
                  "運営・リーシング・修繕計画・現場対応まで。長期運用を見据えた安定稼働を支援します。",
                  "Operations, leasing, maintenance planning, and on-site response for stable long-term operations."
                ),
              },
              {
                title: t("リフォーム／リノベ設計・施工", "Renovation Design & Build"),
                desc: t(
                  "企画・設計・施工管理。DIYと専門工事のハイブリッドでコスト最適化。",
                  "Planning, design, and construction management. Hybrid DIY + professional works for cost optimization."
                ),
              },
              {
                title: t("古民家再生・活用コンサル", "Traditional House Revitalization"),
                desc: t(
                  "現地調査、再生プラン、コスト・収支試算、補助金検討まで伴走。",
                  "Site survey, revitalization plan, cost/returns modeling, and subsidy review."
                ),
              },
              {
      ...
      <section id="works" className="py-16 sm:py-20">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="mt-2 text-neutral-600 text-sm">
            {t("DIY＋プロ施工のハイブリッド事例。民泊化・賃貸リノベの写真を掲載予定。", "Hybrid DIY & pro projects. Guesthouse and rental renovations.")}
          </p>
              ...
              <div className="relative max-w-5xl w-full" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="mt-3 bg-white/95 rounded-xl p-4 shadow flex items-start gap-3">
                  <div className="grow">
                    ...
                    {works[active].note && <div className="text-sm text-neutral-600">{works[active].note}</div>}
                  </div>
                  <button
                    onClick={() => setLightboxOpen(false)}
        ...
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-start">
          <div>
            ...
            <dl className="mt-6 text-sm grid grid-cols-[auto,1fr] gap-x-6 gap-y-3">
              <dt className="text-neutral-500">{t("会社名", "Name")}</dt>
              <dd>株式会社TigerWorks</dd>
              <dt className="text-neutral-500">{t("設立日", "Established")}</dt>
              <dd>2025年6月4日</dd>
              <dt className="text-neutral-500">{t("代表者", "Representative")}</dt>
              <dd>池田 健虎</dd>
              <dt className="text-neutral-500">{t("所在地", "Address")}</dt>
              <dd>〒196-0033 東京都昭島市福島町908-33</dd>
              <dt className="text-neutral-500">{t("資本金", "Capital")}</dt>
              <dd>480万円</dd>
              <dt className="text-neutral-500">{t("事業内容", "Business")}</dt>
              <dd>{t("不動産賃貸業／リノベーション／簡易宿所運営", "Real estate leasing / Renovation / Guesthouse ops")}</dd>
            </dl>
          </div>
            ...
            <ul className="mt-3 text-sm list-disc pl-5 space-y-2 text-neutral-700">
              ...
              <li>
                {t(
                  ...
                  "Material-first design: rather than simply converting tatami rooms to Western style, we reuse and restore original timber, fittings, and plaster."
                )}
              </li>
            </ul>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="mt-6">
            <p className="text-sm text-neutral-600 mb-4">
              {t("お問い合わせは下記フォームよりお願いいたします。", "Please contact us via the form below. Phone number is private.")}
            </p>
